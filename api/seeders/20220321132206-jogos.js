  ...
  async up(queryInterface, Sequelize) {
    return queryInterface.bulkInsert('Jogos', [

      {
        ...
        jogo_url:"https://play.google.com/store/apps/details?id=com.dokye.umdoistresautismo",
        usuario_id: 1,
        createdAt: new Date(),
        updatedAt: new Date()
      },

      {
        ...
        jogo_url:"https://play.google.com/store/apps/details?id=com.imagiRation.imagiRation",
        usuario_id: 1,
        createdAt: new Date(),
        updatedAt: new Date()
      },

      {
        ...
        jogo_url:"https://play.google.com/store/apps/details?id=com.phonegap.matraquinha",
        usuario_id: 1,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        jogo_url:"https://play.google.com/store/apps/details?id=com.Worldwide.count123",
        usuario_id: 1,
        createdAt: new Date(),
        updatedAt: new Date()
      },

      {
        ...
        imagem_url: "https://play-lh.googleusercontent.com/M0Xr6MqAvNAlVtNfkhNxoj4AAUeGZNhpwVke4wcju7s5N8Kav5052o3JEewArUTMliuG=s180-rw",
        jogo_url:"https://play.google.com/store/apps/details?id=com.iz.autispark.kids.autism.games.special.needs.educational.learning.therapy.social.skills.speech",
        usuario_id: 1,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        jogo_url:"https://play.google.com/store/apps/details?id=com.jadeautism.jadeautism",
        usuario_id: 1,
        createdAt: new Date(),
        updatedAt: new Date()
      },

      {
        ...
        jogo_url:"https://play.google.com/store/apps/details?id=com.gerenciar.desenrola",
        usuario_id: 1,
        createdAt: new Date(),
        updatedAt: new Date()
      },

      {
        ...
        jogo_url:"https://play.google.com/store/apps/details?id=org.dreamoriented.leeloo",
        usuario_id: 1,
        createdAt: new Date(),
        updatedAt: new Date()
      },

      {
        ...
        jogo_url:"https://play.google.com/store/apps/details?id=io.gabriel.hahn.autapp",
        usuario_id: 1,
        createdAt: new Date(),
        updatedAt: new Date()
      },

      {
        ...
        jogo_url:"https://play.google.com/store/apps/details?id=ar.com.velociteam.pictoTEA",
        usuario_id: 1,
        createdAt: new Date(),
        updatedAt: new Date()
      },
